...
<div class="text">
В этом разделе находится список организации с кем происходит сотрудничество у организации пользователя. К каждой организации прикрепляются данные для рублевых переводов.
