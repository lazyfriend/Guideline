...
<div class="text">
На сайте открыто большое количество различных функций. Чтобы иметь быстрый доступ к основным из них, функции частично помещаются на главной странице. Так с главной можно посмотреть счета, операции по ним, часто выполняемые действия по шаблонам, можно быстро провести платеж или посмотреть какие платежные получения нужно отправить.
