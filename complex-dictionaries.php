...
<div class="page">
<h1>Комплексные компоненты</h1>

<div class="text">
Шаблоны с отрисованными UI элементами. Используйте слои, чтобы просматривать некоторые активные состояния элементов.


<h2>Справочник "БИК Банка"</h2>

<h2>Справочник "Страна"</h2>

<h2>Справочник "Клиринговый коды"</h2>

<h2>Справочник "Ответственные лица"</h2>

<h2>Справочник "Вид запрлатных карт"</h2>
