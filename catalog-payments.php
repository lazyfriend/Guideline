...
<div class="text">
В этом разделе находится таблица с платежными поручениями, исходящими и входящими требованиями, заявлениями на акцепт, реестры пополнения карт, выплаты сотрудникам. Все документы содержащиеся в этом разделе можно подписать или отправить сразу из таблицы либо зайти внутрь документа и сделать это оттуда. С раздела можно создавать новые платежные поручения и создавать шаблоны часто повторяемых действий.
